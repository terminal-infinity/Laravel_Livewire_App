      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          ...
          <p class="mb-4">Unlocking Potential, Igniting Excellence</p> <a wire:navigate type="button"
            class="btn btn-primary" href="{{ route('servicesPage') }}" data-bs-toggle="modal" data-bs-target="#applyLoan">See More<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
        </div>
      </div>
      <div class="col-lg-6">
