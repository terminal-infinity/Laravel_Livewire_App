		...
		<div class="row justify-content-between">
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="list-inline-item me-4"><a wire:navigate class="text-black" href="{{ route('page',2) }}">Privacy Policy</a>
                        </li>
						<li class="list-inline-item me-4"><a wire:navigate class="text-black" href="{{ route('page',3) }}">Terms &amp; Conditions</a>
                        </li>
					</ul>
				</div>
			</div>			
